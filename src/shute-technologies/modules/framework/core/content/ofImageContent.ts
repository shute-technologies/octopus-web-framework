...
export class OFImageContent extends OFBaseContent{
  ...
  changeProperties (params: {}) {
    if (this.isLoaded) {
      ...
      var minFilter = !params["WebGL_MinFilter"] ? _GL.LINEAR : params["WebGL_MinFilter"];
      var magFilter = !params["WebGL_MagFilter"] ? _GL.LINEAR : params["WebGL_MagFilter"];
      var wrapS = !params["WebGL_WrapS"] ? _GL.CLAMP_TO_EDGE : params["WebGL_WrapS"];
      var wrapT = !params["WebGL_WrapT"] ? _GL.CLAMP_TO_EDGE : params["WebGL_WrapT"];
      var generateMipMaps = !params["GenerateMipMap"] ? false : params["GenerateMipMap"];
